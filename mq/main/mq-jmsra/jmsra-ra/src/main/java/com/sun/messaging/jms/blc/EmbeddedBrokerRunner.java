...
public class EmbeddedBrokerRunner
	...
	/**
	 * This method separates the parameter names from the values considering blank spaces between values
	 *
	 * @param st StrinngTokenaziser with the available tokens
	 * @param v  Vector to save the parameter and the value in consecutive order: parameter then parameter value
	 */
